...
<div id="login">
    <form action="/colar/novo" method="post" class="card-cadastro">
        <div class="card-header">
            <h2>Cadastro colar</h2>
        </div>
        <div class="card-content">
            ...
            <div class="card-content-area">
                <label>Modelo</label>
                <input type="text" name="modelo" value="Colar de coracao">
            </div>

            <div class="card-content-area">
                <label>pingente</label>
                <input type="text" name="pingente" value="true">
            </div>

            <div class="card-content-area">
                <label>peso</label>
                <input type="text" name="peso" value="15">
            </div>

            <div class="card-content-area">
                <label>Nome Produto</label>
                <input type="text" name="nomeProduto" value="Colar de coracao">
            </div>
